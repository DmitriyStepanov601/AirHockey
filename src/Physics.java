/**
 * A class that describes the physics of the game
...
public class Physics {
    ...
    public static float[] calcVel(float velx, float vely) {
        ...
        final double atan = Math.atan((Math.abs(vely) / Math.abs(velx)));
        if (velx < 0 && vely < 0) {
            dir = (float) (270 + atan);
    ...
    public static void collides(Player p, Puck puck) {
        ...
        if (distSqr <= sqrRadius) {
            if (puck.getY() < p.getY() && puck.getX() > (p.getX() - p.getRadius())
                    && puck.getX() < (p.getX() + p.getRadius())) {     // Top
                if (p.getVelY() < 0)
                    puck.setY(p.getY() - (p.getRadius() + puck.getRadius() - p.getVelY() + 1));
                else
                    puck.setY(p.getY() - (p.getRadius() + puck.getRadius() + 1));
            } else if (puck.getY() > p.getY() && puck.getX() > (p.getX() - p.getRadius())
                    && puck.getX() < (p.getX() + p.getRadius())) {     // Bottom
                if (p.getVelY() > 0)
                    puck.setY(p.getY() + (p.getRadius() + puck.getRadius() + p.getVelY() + 1));
                else
                    puck.setY(p.getY() + (p.getRadius() + puck.getRadius() + 1));

            } else if (puck.getX() < p.getX() && puck.getY() > (p.getY() - p.getRadius())
                    && puck.getY() < (p.getY() + p.getRadius())) {     // Left
                if (p.getVelX() < 0)
                    puck.setX(p.getX() - (p.getRadius() + puck.getRadius() - p.getVelX() + 1));
                else
                    puck.setX(p.getX() - (p.getRadius() + puck.getRadius() + 1));
            } else if (puck.getX() > p.getX() && puck.getY() > (p.getY() - p.getRadius())
                    && puck.getY() < (p.getY() + p.getRadius())) {     // Right
                if (p.getVelX() > 0)
                    puck.setX(p.getX() + (p.getRadius() + puck.getRadius() + p.getVelX() + 1));
                else
                    puck.setX(p.getX() + (p.getRadius() + puck.getRadius() + 1));
            ...
            puck.setDir(reflectAngle(puck.getDir()));
            float new_vel = calcVel(p.getVelX() + puck.getVelX(), p.getVelY() + puck.getVelY())[0];
    ...
    public static void collides(AI a, Puck puck) {
        ...
        if (distSqr <= sqrRadius) {
            ...
            if (puck.getY() < a.getY() && puck.getX() > (a.getX() - a.getRadius()) &&
                    puck.getX() < (a.getX() + a.getRadius())) {        // Top
                if (a.getVelY() < 0)
                    puck.setY(a.getY() - (a.getRadius() + puck.getRadius() - a.getVelY() + 1));
                else
                    puck.setY(a.getY() - (a.getRadius() + puck.getRadius() + 1));
            } else if (puck.getY() > a.getY() && puck.getX() > (a.getX() - a.getRadius())
                    && puck.getX() < (a.getX() + a.getRadius())) {     // Bottom
                if (a.getVelY() > 0)
                    puck.setY(a.getY() + (a.getRadius() + puck.getRadius() + a.getVelY() + 1));
                else
                    puck.setY(a.getY() + (a.getRadius() + puck.getRadius() + 1));

            } else if (puck.getX() < a.getX() && puck.getY() > (a.getY() - a.getRadius())
                    && puck.getY() < (a.getY() + a.getRadius())) {       // Left
                if (a.getVelX() < 0)
                    puck.setX(a.getX() - (a.getRadius() + puck.getRadius() - a.getVelX() + 1));
                else
                    puck.setX(a.getX() - (a.getRadius() + puck.getRadius() + 1));
            } else if (puck.getX() > a.getX() && puck.getY() > (a.getY() - a.getRadius())
                    && puck.getY() < (a.getY() + a.getRadius())) {       // Right
                if (a.getVelX() > 0)
                    puck.setX(a.getX() + (a.getRadius() + puck.getRadius() + a.getVelX() + 1));
                else
                    puck.setX(a.getX() + (a.getRadius() + puck.getRadius() + 1));
            ...
            puck.setDir(reflectAngle(puck.getDir()));
            float new_vel = calcVel(a.getVelX() + puck.getVelX(), a.getVelY() + puck.getVelY())[0];
    ...
    public static void collidesWall(Puck p) {
        float angle = p.getDir();
        float new_angle = p.getDir();

        if ((int) p.getX() - p.getRadius() < 15 ||
                (int) p.getX() + p.getRadius() > 486 - 20) {          // Left and right walls
        ...
        if ((int) p.getY() - p.getRadius() < 20
                || (int) p.getY() + p.getRadius() > 759 - 50) {        // Top and botttom walls
